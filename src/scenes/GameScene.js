// Основная игровая сцена: строит карту, создаёт игрока и врагов, связывает физику и UI.
class GameScene extends Phaser.Scene {
  ...
  bindEvents() {
    ...
    this.events.once('shutdown', () => {
      ['player-hp-changed', 'player-attack', 'enemy-dead', 'player-dead'].forEach((e) => this.events.off(e));
    });
  }
